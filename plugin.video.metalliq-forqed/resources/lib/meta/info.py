...
def get_movie_metadata(movie, genres_dict=None):
    ...
    else: info['poster'] = "http://cellardoortv.com/style/themes/MetalliQ-Forqed/unavailable.png"
...
def item_images(type, tmdb_id=None, imdb_id=None, tvdb_id=None, name=None):
    ...
    if isinstance(response, dict):
        ...
        else                            : poster = "http://cellardoortv.com/style/themes/MetalliQ-Forqed/unavailable.png"
