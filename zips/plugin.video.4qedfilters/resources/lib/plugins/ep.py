"""
    ...
    <dir>
        <title>[COLOR aqua]4k Bitches[/COLOR]</title>
        <eporner>category/4k-porn</eporner>
        <thumbnail>https://static-ca-cdn.eporner.com/thumbs/static4/1/14/141/1416382/15_360.jpg</thumbnail>
    </dir>

    <dir>
        <title>[COLOR aqua]HD Videos[/COLOR]</title>
        <eporner>category/hd-1080p</eporner>
        <thumbnail>https://static-ca-cdn.eporner.com/catimg/43.jpg</thumbnail>
    </dir>

    <dir>
        <title>[COLOR aqua]Currently Watched[/COLOR]</title>
        <eporner>currently</eporner>
        <thumbnail></thumbnail>
    </dir>

    <dir>
        <title>[COLOR aqua]Top Rated[/COLOR]</title>
        <eporner>top-rated</eporner>
        <thumbnail></thumbnail>
    </dir>

    <dir>
        <title>[COLOR aqua]Categories[/COLOR]</title>
        <link>http://vario.esy.es/xml/adult//cats.xml</link>
        <thumbnail></thumbnail>
    </dir>

    <dir>
        <title>[COLOR aqua]Pornstars[/COLOR]</title>
        <eporner>pornstars</eporner>
        <thumbnail></thumbnail>
    </dir>

    <dir>
        <title>[COLOR aqua]Search[/COLOR]</title>
...
def category_eporner(url):
    ...
    try:
        ...
        try:
            ...
            xml += "<dir>"\
                   "    <title>[COLORpalegreen]Next Page[/COLOR]</title>"\
                   "    <thumbnail>%s</thumbnail>"\
                   "    <eporner>%s</eporner>"\
...
def play_eporner(url):
    try:
        ...
        selected = xbmcgui.Dialog().select('[COLORlime]4QED XXX[/COLOR] - Get the tissues ready!',names)
        if selected ==  -1:
            return        
