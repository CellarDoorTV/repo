    ...
    class DialogVideoInfo(DialogBaseInfo, window_type):
        ...
        def appintegration_movie(self):
            ...
            if xbmc.getCondVisibility("system.hasaddon(plugin.video.numbersbynumbers)"):
                manage_list.append(["Search NuMbErS", "ActivateWindow(10025,plugin://plugin.video.numbersbynumbers/?action=movieSearch&query="+title+",return)||Notification(NuMbErS:,"+title+",5000,special://home/addons/plugin.video.numbersbynumbers/icon.png)"])
            ...
            if xbmc.getCondVisibility("system.hasaddon(plugin.video.kunt)"):
                manage_list.append(["Search Death Streams", "ActivateWindow(10025,plugin://plugin.video.kunt/?query="+title+"&section=Movies&mode=search_results,return)||Notification(Death Streams:,"+title+",5000,special://home/addons/plugin.video.kunt/icon.png)"])
            if xbmc.getCondVisibility("system.hasaddon(plugin.video.dsrdplus)"):
                manage_list.append(["Search Death Streams RD", "ActivateWindow(10025,plugin://plugin.video.dsrdplus/?query="+title+"&section=Movies&mode=search_results,return)||Notification(Death Streams RD:,"+title+",5000,special://home/addons/plugin.video.dsrdplus/icon.png)"])
            if xbmc.getCondVisibility("system.hasaddon(plugin.video.dsrdplus)"):
                manage_list.append(["Search Death Streams RD", "ActivateWindow(10025,plugin://plugin.video.dsrdplus/?query="+title+"&section=Movies&mode=search_results,return)||Notification(Death Streams RD:,"+title+",5000,special://home/addons/plugin.video.dsrdplus/icon.png)"])
