...
METALLIQ4QED_TV_FOLDER = xbmcaddon.Addon('plugin.video.metalliq-forqed').getSetting('tv_library_folder')
METALLIQ4QED_MOVIE_FOLDER = xbmcaddon.Addon('plugin.video.metalliq-forqed').getSetting('movies_library_folder')
