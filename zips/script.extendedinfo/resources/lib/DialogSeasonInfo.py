...
def get_season_window(window_type):
	...
	class DialogSeasonInfo(DialogBaseInfo, window_type):
		...
		def browse_season(self):
			url = 'plugin://plugin.video.metalliq-forqed/tv/tvdb/%s/%s/' % (self.info['tvdb_id'], self.info['season'])
			self.close()
		...
		def play_season(self):
			url = 'plugin://plugin.video.metalliq-forqed/tv/play/%s/%s/1' % (self.info['tvdb_id'], self.info['season'])
