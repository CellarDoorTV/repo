...
ADDON_PATH = xbmc.translatePath('special://home/addons/script.4qedfilters.xxx/')
USERDATA_PATH = xbmc.translatePath('special://home/userdata/addon_data')
ADDON_DATA = USERDATA_PATH + '/script.4qedfilters.xxx/'
if not os.path.exists(ADDON_DATA):
    os.makedirs(ADDON_DATA)
ICON = ADDON_PATH + 'icon.png'
FANART = ADDON_PATH + 'fanart.jpg'
Dialog = xbmcgui.Dialog()
addon_id = 'script.4qedfilters.xxx'
...
watched_list = xbmc.translatePath('special://home/userdata/addon_data/script.4qedfilters.xxx/watched')
