...
US_Entertainment='%s:%s/enigma2.php?username=%s&password=%s&type=get_live_streams&cat_id=1'%(host,port,username,password)
UK_Sports_3='%s:%s/enigma2.php?username=%s&password=%s&type=get_live_streams&cat_id=698'%(host,port,username,password)
USA_CAN_Sports='%s:%s/enigma2.php?username=%s&password=%s&type=get_live_streams&cat_id=689'%(host,port,username,password)
UK_Entertainment='%s:%s/enigma2.php?username=%s&password=%s&type=get_live_streams&cat_id=691'%(host,port,username,password)
UK_Sports_1='%s:%s/enigma2.php?username=%s&password=%s&type=get_live_streams&cat_id=688'%(host,port,username,password)
...
UK_tv='%s:%s/enigma2.php?username=%s&password=%s&type=get_live_streams&cat_id=687'%(host,port,username,password)
...
UK_Music='%s:%s/enigma2.php?username=%s&password=%s&type=get_live_streams&cat_id=695'%(host,port,username,password)
Canada='%s:%s/enigma2.php?username=%s&password=%s&type=get_live_streams&cat_id=665'%(host,port,username,password)
Canada_backup='%s:%s/enigma2.php?username=%s&password=%s&type=get_live_streams&cat_id=666'%(host,port,username,password)
...
EPL='%s:%s/enigma2.php?username=%s&password=%s&type=get_live_streams&cat_id=15'%(host,port,username,password)
...
Major_League_Soccer='%s:%s/enigma2.php?username=%s&password=%s&type=get_live_streams&cat_id=14'%(host,port,username,password)
...
Australia='%s:%s/enigma2.php?username=%s&password=%s&type=get_live_streams&cat_id=19'%(host,port,username,password)
...
Belgium='%s:%s/enigma2.php?username=%s&password=%s&type=get_live_streams&cat_id=27'%(host,port,username,password)
...
China='%s:%s/enigma2.php?username=%s&password=%s&type=get_live_streams&cat_id=25'%(host,port,username,password)
...
Indonesia='%s:%s/enigma2.php?username=%s&password=%s&type=get_live_streams&cat_id=30'%(host,port,username,password)
Iran='%s:%s/enigma2.php?username=%s&password=%s&type=get_live_streams&cat_id=31'%(host,port,username,password)
Irish='%s:%s/enigma2.php?username=%s&password=%s&type=get_live_streams&cat_id=22'%(host,port,username,password)
Israel='%s:%s/enigma2.php?username=%s&password=%s&type=get_live_streams&cat_id=32'%(host,port,username,password)
...
Latin='%s:%s/enigma2.php?username=%s&password=%s&type=get_live_streams&cat_id=24'%(host,port,username,password)
...
Philippines='%s:%s/enigma2.php?username=%s&password=%s&type=get_live_streams&cat_id=61'%(host,port,username,password)
...
Spain='%s:%s/enigma2.php?username=%s&password=%s&type=get_live_streams&cat_id=37'%(host,port,username,password)
Sweden_Denmark='%s:%s/enigma2.php?username=%s&password=%s&type=get_live_streams&cat_id=38'%(host,port,username,password)
Italy='%s:%s/enigma2.php?username=%s&password=%s&type=get_live_streams&cat_id=33'%(host,port,username,password)
Thai_Lan='%s:%s/enigma2.php?username=%s&password=%s&type=get_live_streams&cat_id=42'%(host,port,username,password)
Switzerland='%s:%s/enigma2.php?username=%s&password=%s&type=get_live_streams&cat_id=39'%(host,port,username,password)
...
def start():
	if username=="":
		...
		if auth == "":
			...
			line3 = "To purchase account email:[COLOR yellowgreen] hypersonictvpro@gmail.com[/COLOR]" 
		...
		if not auth=="":
			...
			tools.addDir('[COLOR gray]Backup Playlist[/COLOR]','live',1,icon,fanart,'')
...
def NEW_MENU():
	...
	if adultset == "false":
		tools.addDir('[COLOR gray]Adult[/COLOR]',Adult,25,adult,fanart,'')
	#tools.addDir('[COLOR gray]Backup Playlist[/COLOR]','live',1,icon,fanart,'')
...
def UK():
	tools.addDir('[B][COLOR white]=-=-=-=-=-=-=-=-=-=[/COLOR][/B] [B][COLOR blue]UK LIVE[/COLOR][/B] [B][COLOR white]=-=-=-=-=-=-=-=-=-=[/COLOR][/B]','','',icon,fanart,'')
	tools.addDir('[COLOR white]UK Entertainment[/COLOR]',UK_Entertainment,25,entertainment,fanart,'')
	tools.addDir('[COLOR white]UK TV[/COLOR]',UK_tv,25,entertainment,fanart,'')
	tools.addDir('[COLOR white]UK Movies[/COLOR]',UK_Movies,25,entertainment,fanart,'')
	tools.addDir('[COLOR white]UK Documentaries[/COLOR]',UK_Documentaries,25,entertainment,fanart,'')
	tools.addDir('[COLOR white]UK Music[/COLOR]',UK_Music,25,entertainment,fanart,'')
	tools.addDir('[COLOR white]UK Kids[/COLOR]',UK_Kids,25,entertainment,fanart,'')
	tools.addDir('[COLOR white]--------[/COLOR] [COLOR blue][B]UK SPORTS[/B][/COLOR] [COLOR white]--------[/COLOR]','','',britsh,fanart,'')
	tools.addDir('[COLOR white]UK Sports (1 of 3)[/COLOR]',UK_Sports_1,25,icon,fanart,'')
...
def INT():
	...
	tools.addDir('[COLOR white]International Sports[/COLOR]',International_Sports,25,international,fanart,'')
	tools.addDir('[COLOR white]Latin[/COLOR]',Latin,25,icon,fanart,'')
	tools.addDir('[COLOR white]Canada[/COLOR]',Canada,25,icon,fanart,'')
	tools.addDir('[COLOR white]Canada (backup)[/COLOR]',Canada_backup,25,icon,fanart,'')
	tools.addDir('[COLOR white]France[/COLOR]',France,25,icon,fanart,'')
	tools.addDir('[COLOR white]Australia[/COLOR]',Australia,25,icon,fanart,'')
	...
	tools.addDir('[COLOR white]Arabic[/COLOR]',Arabic,25,icon,fanart,'')
	tools.addDir('[COLOR white]Turkish[/COLOR]',Turkish,25,icon,fanart,'')
	tools.addDir('[COLOR white]Vietnam[/COLOR]',Vietnam,25,icon,fanart,'')
	tools.addDir('[B][COLOR white]=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=[/COLOR][/B]','','',icon,fanart,'')
	tools.addDir('[COLOR white]Clear Cache[/COLOR]','CC',10,cache,fanart,'')
	tools.addDir('[COLOR white]Search[/COLOR]','url',5,search2,fanart,'')
